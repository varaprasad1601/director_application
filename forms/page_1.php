...
<div class="row justify-content-center align-items-center " id="page-1">
    <div class="col-md-10 box campus py-1 mt-4 px-4 bg-white">
        ...
        <div class="che_che">
        <div class="che_box">
            <div class="col-md-12 px-4 d-flex flex-column"><label class="text" style="margin-bottom:0px;"><b>Select the Campus or Campuses Applied for</b></label><label class="text" style="color: red; font-size:15px;">Note: If you wish to apply more than one campus, select all those campuses.</label></div>
