...
<body>
    <div class="container-fluid main-head pt-3">
        <div class="row px-3">
            <div class="col-dm-12 d-flex head pb-1 px-0" style="border-bottom:1px solid lightgray;">
                <div class="col-md-1 rgukt d-flex justify-content-center align-items-center">
                    <img src="./logo.png" class="logoo" width="86">
                </div>
                <div class="col-md-10 justify-content-center pt-2 heading" style="color: #560207; text-align:center;">
                    <p style="font-size: 30px; font-family:'Arial' !important; font-weight:bold;" class="heading-1">Rajiv Gandhi University of Knowledge Technologies - Andhra Pradesh</p>
